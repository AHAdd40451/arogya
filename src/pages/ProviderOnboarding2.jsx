    ...
    <OnboardingLayout step={2} totalSteps={5} title="Professional Credentials" subtitle="Tell us about your NP license and practice area." role="provider">
      <div className="space-y-4">
        <div>
          ...
          <Input placeholder="NP-123456" value={form.license} onChange={(e) => setForm({ ...form, license: e.target.value })} className="mt-1.5" />
        </div>
        <div>
        ...
        <div>
          ...
          <Input type="number" placeholder="5" value={form.years} onChange={(e) => setForm({ ...form, years: e.target.value })} className="mt-1.5" />
        </div>
        <div>
        ...
        <Button onClick={() => navigate(createPageUrl("ProviderOnboarding3"))} className="w-full bg-teal-600 hover:bg-teal-700 rounded-xl py-5 mt-2">
          Continue →
        </Button>
      </div>
    </OnboardingLayout>
